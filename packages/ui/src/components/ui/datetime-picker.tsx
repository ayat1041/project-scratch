        ...
        MonthCaption: ({ calendarMonth }) => {
          return (
            <div className="inline-flex gap-2">
              ...
              >
                <SelectTrigger
                  className="focus:bg-accent focus:text-accent-foreground w-fit gap-1 border-none p-0"
  ...
  (
    {
      ...
      value,
      onChange,
      // hourCycle is part of the public prop shape but the hour-format display
      // branch below is currently commented out, so it's unused here.
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild disabled={disabled}>
          ...
          >
            ...
            {displayDate ? (
              <span>{format(displayDate, 'dd-MM-yyyy', { locale: loc })}</span>
            ) : (
              <span>{placeholder}</span>
            )}
          </Button>
